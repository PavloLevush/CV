...
// TCPWM_P4_v2_10(Clock_CheckTolerance=true, Clock_desired_freq=12, Clock_desired_freq_unit=6, Clock_divisor=1, Clock_FractDividerDenominator=0, Clock_FractDividerNumerator=0, Clock_FractDividerUsed=false, Clock_is_direct=false, Clock_is_divider=false, Clock_is_freq=true, Clock_minus_tolerance=5, Clock_ph_align_clock_id=, Clock_ph_align_clock_name=, Clock_plus_tolerance=5, Clock_source_clock_id=, Clock_source_clock_name=, PinVisibility_index=false, PinVisibility_kill=false, PinVisibility_phiA=false, PinVisibility_phiB=false, PinVisibility_switch=false, PWMCompare=65535, PWMCompareBuf=65535, PWMCompareSwap=0, PWMCountMode=3, PWMCountPresent=false, PWMDeadTimeCycle=0, PWMInterruptMask=1, PWMKillEvent=0, PWMLinenSignal=0, PWMLineSignal=0, PWMMode=4, PWMPeriod=65535, PWMPeriodBuf=65535, PWMPeriodSwap=0, PWMPrescaler=0, PWMReloadMode=0, PWMReloadPresent=false, PWMRunMode=0, PWMSetAlign=0, PWMStartMode=0, PWMStartPresent=false, PWMStopEvent=0, PWMStopMode=0, PWMStopPresent=false, PWMSwitchMode=0, PWMSwitchPresent=false, QuadAutoStart=true, QuadEncodingModes=0, QuadIndexMode=0, QuadIndexPresent=false, QuadInterruptMask=1, QuadPhiAMode=3, QuadPhiBMode=3, QuadStopMode=0, QuadStopPresent=false, TCCaptureMode=1, TCCapturePresent=true, TCCompare=65535, TCCompareBuf=65535, TCCompareSwap=0, TCCompCapMode=2, TCCountingModes=0, TCCountMode=3, TCCountPresent=false, TCInterruptMask=2, TCPeriod=65535, TCPrescaler=0, TCPWMCapturePresent=false, TCPWMConfig=1, TCPWMCountPresent=false, TCPWMReloadPresent=false, TCPWMStartPresent=false, TCPWMStopPresent=false, TCReloadMode=0, TCReloadPresent=true, TCRunMode=0, TCStartMode=0, TCStartPresent=true, TCStopMode=1, TCStopPresent=true, TermMode_capture=0, TermMode_cc=0, TermMode_clock=0, TermMode_count=0, TermMode_interrupt=0, TermMode_line=0, TermMode_line_n=0, TermMode_ov=0, TermMode_reload=0, TermMode_start=0, TermMode_stop=0, TermMode_un=0, TermModeStates=, TermVisibility_capture=true, TermVisibility_cc=true, TermVisibility_clock=true, TermVisibility_count=false, TermVisibility_interrupt=true, TermVisibility_line=false, TermVisibility_line_n=false, TermVisibility_ov=true, TermVisibility_reload=true, TermVisibility_start=true, TermVisibility_stop=true, TermVisibility_un=true, CY_API_CALLBACK_HEADER_INCLUDE=, CY_COMMENT=, CY_COMPONENT_NAME=TCPWM_P4_v2_10, CY_CONFIG_TITLE=Timer_Echo_3, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=Timer_Echo_3, CY_INSTANCE_SHORT_NAME=Timer_Echo_3, CY_MAJOR_VERSION=2, CY_MINOR_VERSION=10, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.4, INSTANCE_NAME=Timer_Echo_3, )
...
module top ;
    ...
    assign Net_2432 = 1'h1;

    assign Net_2433 = 1'h0;
	...
	wire [0:0] tmpOE__Pin_US_Echo_1_net;
	wire [0:0] tmpIO_0__Pin_US_Echo_1_net;
	wire [0:0] tmpINTERRUPT_0__Pin_US_Echo_1_net;
	electrical [0:0] tmpSIOVREF__Pin_US_Echo_1_net;

	cy_psoc3_pins_v1_10
		#(.id("6a2d81d7-6564-4ef5-b6ca-67ae989b3424"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Pin_US_Echo_1
		 (.oe(tmpOE__Pin_US_Echo_1_net),
		  .y({1'b0}),
		  .fb({Net_155}),
		  .io({tmpIO_0__Pin_US_Echo_1_net[0:0]}),
		  .siovref(tmpSIOVREF__Pin_US_Echo_1_net),
		  .interrupt({tmpINTERRUPT_0__Pin_US_Echo_1_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Pin_US_Echo_1_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

    TCPWM_P4_v2_10_5 Timer_Echo_1 (
        .capture(Net_155),
        .cc(Net_2460),
        .clock(Net_2330),
        .count(1'b1),
    ...
    assign Net_2441 = 1'h0;

    assign Net_2443 = 1'h0;

    assign Net_2440 = 1'h1;

    TCPWM_P4_v2_10_6 Timer_Echo_3 (
        .capture(Net_2346),
        .cc(Net_2445),
        .clock(Net_2330),
        .count(1'b1),
	...
	wire [0:0] tmpOE__Pin_US_Echo_3_net;
	wire [0:0] tmpIO_0__Pin_US_Echo_3_net;
	wire [0:0] tmpINTERRUPT_0__Pin_US_Echo_3_net;
	electrical [0:0] tmpSIOVREF__Pin_US_Echo_3_net;

	cy_psoc3_pins_v1_10
		#(.id("08e7f340-360d-47f0-8590-b6c8aadf7280"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Pin_US_Echo_3
		 (.oe(tmpOE__Pin_US_Echo_3_net),
		  .y({1'b0}),
		  .fb({Net_2346}),
		  .io({tmpIO_0__Pin_US_Echo_3_net[0:0]}),
		  .siovref(tmpSIOVREF__Pin_US_Echo_3_net),
		  .interrupt({tmpINTERRUPT_0__Pin_US_Echo_3_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Pin_US_Echo_3_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	assign tmpOE__Pin_US_Trigger_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Pin_US_Trigger_1_net;
	wire [0:0] tmpFB_0__Pin_US_Trigger_1_net;
	wire [0:0] tmpIO_0__Pin_US_Trigger_1_net;
	wire [0:0] tmpINTERRUPT_0__Pin_US_Trigger_1_net;
	electrical [0:0] tmpSIOVREF__Pin_US_Trigger_1_net;

	cy_psoc3_pins_v1_10
		#(.id("3bc21cf4-a138-4b63-882f-d4e50975d1e4"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Pin_US_Trigger_1
		 (.oe(tmpOE__Pin_US_Trigger_1_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Pin_US_Trigger_1_net[0:0]}),
		  .io({tmpIO_0__Pin_US_Trigger_1_net[0:0]}),
		  .siovref(tmpSIOVREF__Pin_US_Trigger_1_net),
		  .interrupt({tmpINTERRUPT_0__Pin_US_Trigger_1_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Pin_US_Trigger_1_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Pin_US_Trigger_2_net;
	wire [0:0] tmpFB_0__Pin_US_Trigger_2_net;
	wire [0:0] tmpIO_0__Pin_US_Trigger_2_net;
	wire [0:0] tmpINTERRUPT_0__Pin_US_Trigger_2_net;
	electrical [0:0] tmpSIOVREF__Pin_US_Trigger_2_net;

	cy_psoc3_pins_v1_10
		#(.id("378d706a-fb36-4670-98ad-a43578a161bb"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Pin_US_Trigger_2
		 (.oe(tmpOE__Pin_US_Trigger_2_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Pin_US_Trigger_2_net[0:0]}),
		  .io({tmpIO_0__Pin_US_Trigger_2_net[0:0]}),
		  .siovref(tmpSIOVREF__Pin_US_Trigger_2_net),
		  .interrupt({tmpINTERRUPT_0__Pin_US_Trigger_2_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Pin_US_Trigger_2_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Pin_US_Trigger_3_net;
	wire [0:0] tmpFB_0__Pin_US_Trigger_3_net;
	wire [0:0] tmpIO_0__Pin_US_Trigger_3_net;
	wire [0:0] tmpINTERRUPT_0__Pin_US_Trigger_3_net;
	electrical [0:0] tmpSIOVREF__Pin_US_Trigger_3_net;

	cy_psoc3_pins_v1_10
		#(.id("ca914657-2dd8-46d3-a446-7998c137348f"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Pin_US_Trigger_3
		 (.oe(tmpOE__Pin_US_Trigger_3_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Pin_US_Trigger_3_net[0:0]}),
		  .io({tmpIO_0__Pin_US_Trigger_3_net[0:0]}),
		  .siovref(tmpSIOVREF__Pin_US_Trigger_3_net),
		  .interrupt({tmpINTERRUPT_0__Pin_US_Trigger_3_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Pin_US_Trigger_3_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
