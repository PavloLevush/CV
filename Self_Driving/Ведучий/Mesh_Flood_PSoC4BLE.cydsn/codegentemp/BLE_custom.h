...
#define CYBLE_MOTORSERVICE_SERVICE_INDEX   (0x01u) /* Index of MotorService service in the cyBle_customs array */
...
#define CYBLE_MOTORSERVICE_SERVICE_HANDLE   (0x0012u) /* Handle of MotorService service */
#define CYBLE_MOTORSERVICE_SPEEDLEFT_DECL_HANDLE   (0x0013u) /* Handle of SpeedLeft characteristic declaration */
#define CYBLE_MOTORSERVICE_SPEEDLEFT_CHAR_HANDLE   (0x0014u) /* Handle of SpeedLeft characteristic */
#define CYBLE_MOTORSERVICE_SPEEDLEFT_CHARACTERISTIC_USER_DESCRIPTION_DESC_HANDLE   (0x0015u) /* Handle of Characteristic User Description descriptor */
#define CYBLE_MOTORSERVICE_SPEEDRIGHT_DECL_HANDLE   (0x0016u) /* Handle of SpeedRight characteristic declaration */
#define CYBLE_MOTORSERVICE_SPEEDRIGHT_CHAR_HANDLE   (0x0017u) /* Handle of SpeedRight characteristic */
#define CYBLE_MOTORSERVICE_SPEEDRIGHT_CHARACTERISTIC_USER_DESCRIPTION_DESC_HANDLE   (0x0018u) /* Handle of Characteristic User Description descriptor */
